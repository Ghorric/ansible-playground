...
sh ./docker/docker-dind-ansible-playbook/scripts/RunServerAnsible.sh sh ./docker/docker-dind-ansible-playbook/scripts/StartDockerDaemonAndAnsible.sh -i "ansible/inventories/only-localhost.ini" "ansible/playbooks/DockerRun.yml"