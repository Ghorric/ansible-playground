...
sh ./docker/docker-dind-ansible-playbook/scripts/RunServerAnsible.sh sh ./docker/docker-dind-ansible-playbook/scripts/StartDockerDaemonAndAnsible.sh -i "ansible/inventories/hosts-docker.ini" "ansible/playbooks/site.yml" $@